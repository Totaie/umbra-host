...
#pragma GCC diagnostic pop
  ...
  if (windows_version.build_number.has_value() && *windows_version.build_number < 22000) {
    BOOST_LOG(warning) << "Windows 10 detected; HDR will not work on the Umbra Virtual Display.";
  }
#endif
  ...
  on_signal(SIGINT, [&shutdown_signal_requested, shutdown_event]() {
    ...
    // Preserve Umbra's eager application cleanup; the owned deadline above
