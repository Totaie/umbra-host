...
function(_umbra_generate_sortable_product_guid _output_variable)
  set(_guid "")
...
_umbra_generate_sortable_product_guid(_umbra_product_guid)
set(CPACK_WIX_PRODUCT_GUID "${_umbra_product_guid}")
...
if(DEFINED CPACK_PACKAGE_DIRECTORY AND DEFINED CPACK_SYSTEM_NAME AND DEFINED CPACK_GENERATOR)
  set(_umbra_wix_stage
    "${CPACK_PACKAGE_DIRECTORY}/_CPack_Packages/${CPACK_SYSTEM_NAME}/${CPACK_GENERATOR}"
  )
  if(EXISTS "${_umbra_wix_stage}")
    file(REMOVE_RECURSE "${_umbra_wix_stage}")
    message(STATUS "Removed stale CPack WiX staging directory: ${_umbra_wix_stage}")
  endif()
endif()
