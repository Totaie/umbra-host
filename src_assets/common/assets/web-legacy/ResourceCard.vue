...
const resources = computed(() => [
  ...
  {
    href: 'https://github.com/Totaie/umbra-host/discussions',
    icon: 'fab fa-github',
  ...
  {
    href: 'https://github.com/Totaie/umbra-host/issues',
    icon: 'fab fa-github',
...
const legalLinks = computed(() => [
  {
    href: 'https://github.com/Totaie/umbra-host/blob/master/LICENSE',
  ...
  {
    href: 'https://github.com/Totaie/umbra-host/blob/master/NOTICE',
