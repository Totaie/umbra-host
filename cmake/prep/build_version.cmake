...
set(SUNSHINE_REPO_OWNER "Totaie" CACHE STRING "GitHub repo owner for update checks")
set(SUNSHINE_REPO_NAME "umbra-host" CACHE STRING "GitHub repo name for update checks")
...
if(DEFINED GITHUB_CLONE_URL AND (SUNSHINE_REPO_OWNER STREQUAL "Totaie" OR SUNSHINE_REPO_NAME STREQUAL "umbra-host"))
...
list(APPEND SUNSHINE_DEFINITIONS RC_VERSION_BUILD=${RC_VERSION_BUILD})
list(APPEND SUNSHINE_DEFINITIONS RC_VERSION_REVISION=${RC_VERSION_REVISION})
