...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            **Windows:**
            <br>
            Select the adapter in the web interface so Umbra can save both
            ...
            attached (for example a TV that is powered off), Umbra does **not** fall back to another
...
<table>
    <tr>
        ...
        <td colspan="2">
            ...
            The same identity selects the render adapter when Umbra creates
...
<table>
    <tr>
        <td>Description</td>
        <td colspan="2">
            When enabled, Umbra uses the Umbra Display Driver for virtual display streams. Disable this to switch back to the bundled SudoVDA rollback driver.
            @note{Applies to Windows only.}
        </td>
    </tr>
    <tr>
...
is not offered to clients even though Umbra's own AMF check only needs 1.4.23. Update your
...
and is not subject to FFmpeg's 10-bit refusal. Umbra carries one narrow exception for the legacy
